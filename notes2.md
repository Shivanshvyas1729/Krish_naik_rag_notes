...
1. [Multimodal RAG (`07_multimodle RAG`)](#13-multimodal-rag-07_multimodle-rag)
    * [Multimodal RAG with OpenAI (GPT-4o) & CLIP Joint Embeddings (`1-multimodalopenai.ipynb`)](#131-multimodal-rag-with-openai-gpt-4o--clip-joint-embeddings-1-multimodalopenaiipynb)4o--clip-joint-embeddings-1-multimodalopenaiipynb)
